...
export default function Footer() {
  return (
    <div className="bg-bg-dark flex flex-col items-center px-6 py-6">
      <div className="flex w-full max-w-5xl flex-wrap items-center justify-center gap-6 sm:justify-between">
        ...
        <ul className="text-text flex flex-wrap justify-center gap-6 font-sans text-base font-bold opacity-70">
